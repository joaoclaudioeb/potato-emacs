...
#+begin_src emacs-lisp
  ...
  ;;   "Insert the ASCII banner with custom styling."
  ;;   (when dashboard-startup-banner
  ;;     (let ((lines (if (stringp dashboard-startup-banner)
  ;;                    (with-temp-buffer
  ;;                      (insert-file-contents dashboard-startup-banner)
  ;;                      (split-string (buffer-string) "\n" t))
  ;;                    (split-string dashboard-startup-banner "\n" t))))
  ;;       (dolist (line lines)
      ...
      `(
         ((,(all-the-icons-faicon "github" :height 1.2 :v-adjust 0.0)
           ...
           (,(all-the-icons-faicon "home" :height 1.2 :v-adjust 0.0)
             ...
             (lambda (&rest _) (browse-url "https://github.com/joaoclaudioeb"))))))
    :config
    ;; (set-face-attribute 'dashboard-text-banner nil :height 0.6)
...
#+begin_src emacs-lisp
  (defun load-my-theme (theme)
    (cond
      ...
      ((eq theme 'doom-one) ; (TODO) Still needs some attention...
...
#+begin_src emacs-lisp
  ...
  (setq org-todo-keyword-faces
    '(("TODO" . org-warning) ("IN-PROGRESS" . org-done) ("WAITING" . "orange")
  ...
  (setq eshell-prompt-function
    (lambda ()
      (concat
        ...
        ;;   (propertize (concat " (" pyvenv-virtual-env-name ")") 'face 'font-lock-keyword-face)
